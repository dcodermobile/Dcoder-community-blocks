...
const dateFormat = __nccwpck_require__(992);
...
var httpFollow = __nccwpck_require__(907).http;
var httpsFollow = __nccwpck_require__(907).https;
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __nccwpck_require__(545)("follow-redirects");
    }
    catch (error) {
      debug = function () { /* */ };
    }
...
var debug = __nccwpck_require__(266);
