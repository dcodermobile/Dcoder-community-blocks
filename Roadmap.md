As a new contributor you can submit your block for one of the apps listed or for an overall theme category.
...
## Twilio
  ...
  - [ ] DELETE /Accounts/{AccountSid}/SIP/IpAccessControlLists/{IpAccessControlListSid}/IpAddresses/{IpAddressSid}
...
## BitBucket
  ...
  - [ ] GET /teams/{username}
  - [ ] PUT /repositories/{username}/{repo_slug}/pipelines_config/variables/{variable_uuid}
...
## Intercom
  ...
  - [ ] Intercom Create Contact With Source
  - [ ] Create Conversation
...
## Monday
  - [ ] Get Item by Id
  - [ ] Find items in board by column value
  - [ ] Post an update to an item
## Google Dialogflow
## Coda
  - [ ] POST /docs/{docId}/tables/{tableIdOrName}/rows
  - [ ] GET /docs/{docId}/views/{viewIdOrName}
  ...
  - [ ] GET /docs/{docId}/views/{viewIdOrName}/columns
  - [ ] GET /docs/{docId}/controls
  - [ ] DELETE /docs/{docId}
  - [ ] GET /docs/{docId}/tables/{tableIdOrName}/rows/{rowIdOrName}
  - [ ] GET /docs/{docId}/views/{viewIdOrName}/rows
...
## Formstack
## Postmark
  - [ ] Send an Email with Postmark to a Single Recipient
## SSH (key-based auth)
## Segment
...
## Twitter Developer App
  ...
  - [ ] Twitter Developer Account - Post Tweet
## Algolia
...
## PagerDuty
  ...
  - [ ] POST /addons
  - [ ] PUT /extensions/{id}
  - [ ] X-DESCRIPTION /api_reference
  - [ ] X-DESCRIPTION /schedules/{id}/overrides
  - [ ] X-DESCRIPTION /users/{id}/roles
  - [ ] X-DESCRIPTION /maintenance_windows/{id}
  - [ ] X-DESCRIPTION /incidents/{id}/status_updates
  - [ ] X-DESCRIPTION /teams/{id}/members
  - [ ] POST /escalation_policies
  - [ ] X-DESCRIPTION /response_plays/{response_play_id}/run
  - [ ] X-DESCRIPTION /services
  - [ ] DELETE /users/{id}/contact_methods/{contact_method_id}
  - [ ] GET /addons
  - [ ] X-DESCRIPTION /services/{id}
  - [ ] GET /addons/{id}
  - [ ] X-DESCRIPTION /incidents/{id}/merge
  ...
  - [ ] GET /tags
  - [ ] X-DESCRIPTION /services/{id}/integrations
  - [ ] PUT /incidents/{id}
  - [ ] X-DESCRIPTION /extension_schemas/{id}
  - [ ] GET /schedules
  - [ ] GET /users
  - [ ] X-DESCRIPTION /incidents/{id}/responder_requests
  - [ ] GET /escalation_policies/{id}
  - [ ] X-DESCRIPTION /teams/{id}/escalation_policies/{escalation_policy_id}
  - [ ] DELETE /maintenance_windows/{id}
  - [ ] X-DESCRIPTION /incidents/{id}/snooze
  - [ ] X-DESCRIPTION /notifications
  - [ ] PUT /escalation_policies/{id}
  - [ ] PUT /teams/{id}/escalation_policies/{escalation_policy_id}
  - [ ] X-DESCRIPTION /schedules/{id}
  - [ ] DELETE /users/{id}
  - [ ] POST /extensions
  - [ ] X-DESCRIPTION /abilities
  - [ ] X-DESCRIPTION /users/{id}/contact_methods
  - [ ] GET /incidents
  - [ ] POST /schedules/{id}/overrides
  - [ ] GET /abilities
  - [ ] GET /users/{id}/contact_methods
  - [ ] X-DESCRIPTION /schedules/{id}/overrides/{override_id}
  - [ ] PUT /incidents
  ...
  - [ ] X-DESCRIPTION /tags/{id}
  - [ ] X-DESCRIPTION /services/{id}/integrations/{integration_id}
  - [ ] X-DESCRIPTION /users/{id}/sessions
  - [ ] X-DESCRIPTION /incidents/{id}/log_entries
  - [ ] DELETE /users/{id}/sessions/{type}/{session_id}
  - [ ] X-DESCRIPTION /{entity_type}/{id}/tags
  - [ ] POST /teams
  ...
  - [ ] X-DESCRIPTION /addons
  - [ ] DELETE /services/{id}
  - [ ] X-DESCRIPTION /incidents/{id}
  - [ ] PUT /addons/{id}
  - [ ] X-DESCRIPTION /users/{id}/notification_rules/{notification_rule_id}
  - [ ] GET /{entity_type}/{id}/tags
  - [ ] X-DESCRIPTION /vendors
  - [ ] X-DESCRIPTION /log_entries/{id}
  - [ ] GET /incidents/{id}/log_entries
  - [ ] GET /teams
  - [ ] GET /abilities/{id}
  - [ ] X-DESCRIPTION /priorities
  - [ ] X-DESCRIPTION /schedules/{id}/users
  - [ ] X-DESCRIPTION /users/{id}/contact_methods/{contact_method_id}
  - [ ] X-DESCRIPTION /extension_schemas
  - [ ] GET /log_entries
  - [ ] GET /oncalls
  - [ ] PUT /teams/{id}/users/{user_id}
  - [ ] X-DESCRIPTION /tags/{id}/{entity_type}
  - [ ] GET /incidents/{id}/alerts/{alert_id}/
  - [ ] X-DESCRIPTION /users/{id}/sessions/{type}/{session_id}
  - [ ] X-DESCRIPTION /services/{id}/integrations/{integration_id}/regenerate_key
  - [ ] GET /notifications
  - [ ] POST /incidents/{id}/snooze
  - [ ] X-DESCRIPTION /escalation_policies/{id}/escalation_rules
  - [ ] X-DESCRIPTION /teams/{id}/users/{user_id}
  - [ ] GET /extensions/{id}
  - [ ] DELETE /schedules/{id}
  - [ ] X-DESCRIPTION /users/me
  ...
  - [ ] X-DESCRIPTION /abilities/{id}
  - [ ] POST /users/{id}/contact_methods
  - [ ] DELETE /tags/{id}
  - [ ] DELETE /users/{id}/sessions
  - [ ] GET /services/{id}/integrations/{integration_id}
  - [ ] X-DESCRIPTION /incidents/{id}/alerts/{alert_id}/
  - [ ] X-DESCRIPTION /extensions
  - [ ] X-DESCRIPTION /schedules/preview
  - [ ] X-DESCRIPTION /users/{id}
  - [ ] X-DESCRIPTION /log_entries
  - [ ] DELETE /teams/{id}/users/{user_id}
  - [ ] X-DESCRIPTION /escalation_policies/{id}/escalation_rules/{escalation_rule_id}
## Quickbooks
  - [ ] Create Vendor
...
## Customer.io
  ...
  - [ ] Send Anonymous Event To Customer io
## Vercel
...
## Gorgias
  - [ ] Gorgias Customer Profile Lookup and Open New Ticket
## Infobip
## NewsAPI
## Autopilot
  - [ ] Add Guide to AP List
## Moosend
  - [ ] Add subscriber
  - [ ] Get mailing lists
## Linear App
...
## Splitwise
  ...
  - [ ] Get expenses
## LaunchDarkly
  - [ ] Toggle feature flag targeting
  - [ ] Update Flag's default variation
## awork
## Procore
## Lawmatics
## OneSignal (User Auth)
...
## Full Contact
  - [ ] People Enrich
  - [ ] People Resolve Delete Customer Record
  - [ ] Company Look Up By Domain
  - [ ] Get Account Stats
  - [ ] Company Search By Name
  - [ ] Verify Email
  - [ ] Subscribe to Contact
  - [ ] People Resolve Map Customer Record
  - [ ] People Resolve - Resolve Customer Record
...
## 8x8 (Wavecell)
## Ongage
  - [ ] Ongage Find Subscriber
  - [ ] Ongage Subscribe
  - [ ] Ongage Update Subscriber
## DaData.ru
## What Converts
## Feedbin
  - [ ] Get subscriptions
...
## Zerys
## Sendfox (OAuth)
  - [ ] Add new contact into a specific list
## Capsule
## Google Slides
