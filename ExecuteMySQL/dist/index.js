...
const mysql = __nccwpck_require__(8806);
...
var isProperty = __nccwpck_require__(375)
...
var Buffer = __nccwpck_require__(6836).Buffer;
...
var modules = [
    __nccwpck_require__(3546),
    __nccwpck_require__(5754),
    __nccwpck_require__(3018),
    __nccwpck_require__(6991),
    __nccwpck_require__(3283),
    __nccwpck_require__(5469),
    __nccwpck_require__(6131),
    __nccwpck_require__(3248),
...
var bomHandling = __nccwpck_require__(9917),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __nccwpck_require__(198); // Lazy load all encoding definitions.
...
const Yallist = __nccwpck_require__(9196)
...
const SqlString = __nccwpck_require__(4138);

const Connection = __nccwpck_require__(7945);
const ConnectionConfig = __nccwpck_require__(1168);
const parserCache = __nccwpck_require__(9927);
...
const Pool = __nccwpck_require__(561);
const PoolCluster = __nccwpck_require__(7863);

exports.createPool = function(config) {
  const PoolConfig = __nccwpck_require__(3958);
...
exports.createServer = function(handler) {
  const Server = __nccwpck_require__(2965);
  const s = new Server();
  if (handler) {
...
exports.PoolConnection = __nccwpck_require__(2904);
...
exports.__defineGetter__(
  ...
  () => __nccwpck_require__(8806).createConnection
);

exports.__defineGetter__(
  'createPoolPromise',
  () => __nccwpck_require__(8806).createPool
);

exports.__defineGetter__(
  'createPoolClusterPromise',
  () => __nccwpck_require__(8806).createPoolCluster
);

exports.__defineGetter__('Types', () => __nccwpck_require__(4297));
...
const crypto = __nccwpck_require__(6417);
const { xor, xorRotating } = __nccwpck_require__(1211);
...
const auth41 = __nccwpck_require__(1211);
...
const crypto = __nccwpck_require__(6417);
const { xor } = __nccwpck_require__(1211);
...
const Packets = __nccwpck_require__(9087);
const sha256_password = __nccwpck_require__(4265);
const caching_sha2_password = __nccwpck_require__(6196);
const mysql_native_password = __nccwpck_require__(1734);
...
const Command = __nccwpck_require__(5747);
const Packets = __nccwpck_require__(9087);
...
class QueryEvent {
  constructor(packet) {
    const parseStatusVars = __nccwpck_require__(3070);
...
const Command = __nccwpck_require__(5747);
const Packets = __nccwpck_require__(9087);
const ClientHandshake = __nccwpck_require__(4424);
const CharsetToEncoding = __nccwpck_require__(2749);
...
const Command = __nccwpck_require__(5747);
const Packets = __nccwpck_require__(9087);
const ClientConstants = __nccwpck_require__(3145);
const CharsetToEncoding = __nccwpck_require__(2749);
const auth41 = __nccwpck_require__(1211);
...
class ClientHandshake extends Command {
  ...
  handshakeResult(packet, connection) {
    ...
    if (marker === 0xfe || marker === 1) {
      const authSwitch = __nccwpck_require__(8619);
      try {
        if (marker === 1) {
    ...
    if (!connection.authorized) {
      ...
      if (connection.config.compress) {
        const enableCompression = __nccwpck_require__(3442).enableCompression;
...
const Command = __nccwpck_require__(5747);
const Query = __nccwpck_require__(9863);
const Packets = __nccwpck_require__(9087);

const getBinaryParser = __nccwpck_require__(3243);
...
const ClientHandshake = __nccwpck_require__(4424);
const ServerHandshake = __nccwpck_require__(8549);
const Query = __nccwpck_require__(9863);
const Prepare = __nccwpck_require__(6158);
const CloseStatement = __nccwpck_require__(9533);
const Execute = __nccwpck_require__(469);
const Ping = __nccwpck_require__(726);
const RegisterSlave = __nccwpck_require__(8124);
const BinlogDump = __nccwpck_require__(6837);
const ChangeUser = __nccwpck_require__(237);
const Quit = __nccwpck_require__(9664);
...
const Command = __nccwpck_require__(5747);
const CommandCode = __nccwpck_require__(1415);
const Packet = __nccwpck_require__(555);
...
const Command = __nccwpck_require__(5747);
const Packets = __nccwpck_require__(9087);
const getTextParser = __nccwpck_require__(3683);
const ServerStatus = __nccwpck_require__(818);
const CharsetToEncoding = __nccwpck_require__(2749);
...
const CommandCode = __nccwpck_require__(1415);
const Errors = __nccwpck_require__(5817);
...
const PacketParser = __nccwpck_require__(9910);
...
function enableCompression(connection) {
  ...
  const seqqueue = __nccwpck_require__(273);
...
const EventEmitter = __nccwpck_require__(8614).EventEmitter;
const Readable = __nccwpck_require__(2413).Readable;
const Queue = __nccwpck_require__(451);
const SqlString = __nccwpck_require__(4138);
const LRU = __nccwpck_require__(1844);

const PacketParser = __nccwpck_require__(9910);
const Packets = __nccwpck_require__(9087);
const Commands = __nccwpck_require__(2113);
const ConnectionConfig = __nccwpck_require__(1168);
const CharsetToEncoding = __nccwpck_require__(2749);
...
class Connection extends EventEmitter {
  ...
  promise(promiseImpl) {
    const PromiseConnection = __nccwpck_require__(8806).PromiseConnection;
  ...
  _resolveNamedPlaceholders(options) {
    ...
    if (this.config.namedPlaceholders || options.namedPlaceholders) {
      ...
      if (convertNamedPlaceholders === null) {
        convertNamedPlaceholders = __nccwpck_require__(3548)();
      }
...
const ClientConstants = __nccwpck_require__(3145);
const Charsets = __nccwpck_require__(2527);
...
class ConnectionConfig {
  ...
  static getSSLProfile(name) {
    if (!SSLProfiles) {
      SSLProfiles = __nccwpck_require__(373);
    }
...
try {
  highlightFn = __nccwpck_require__(6932).highlight;
} catch (err) {
  highlightFn = text => {
...
const Types = __nccwpck_require__(4297);
const Packet = __nccwpck_require__(555);
...
const Packet = __nccwpck_require__(555);
const CommandCodes = __nccwpck_require__(1415);
...
const Packet = __nccwpck_require__(555);
const StringParser = __nccwpck_require__(6698);
const CharsetToEncoding = __nccwpck_require__(2749);
...
const CursorType = __nccwpck_require__(2677);
const CommandCodes = __nccwpck_require__(1415);
const Types = __nccwpck_require__(4297);
const Packet = __nccwpck_require__(555);
const CharsetToEncoding = __nccwpck_require__(2749);
...
const AuthSwitchRequest = __nccwpck_require__(7322);
const AuthSwitchRequestMoreData = __nccwpck_require__(7168);
const AuthSwitchResponse = __nccwpck_require__(3521);
const BinaryRow = __nccwpck_require__(2465);
const BinlogDump = __nccwpck_require__(6816);
const ChangeUser = __nccwpck_require__(5436);
const CloseStatement = __nccwpck_require__(1826);
const ColumnDefinition = __nccwpck_require__(6561);
const Execute = __nccwpck_require__(1064);
const Handshake = __nccwpck_require__(7440);
const HandshakeResponse = __nccwpck_require__(2772);
const PrepareStatement = __nccwpck_require__(6029);
const PreparedStatementHeader = __nccwpck_require__(8872);
const Query = __nccwpck_require__(5449);
const RegisterSlave = __nccwpck_require__(2884);
const ResultSetHeader = __nccwpck_require__(2502);
const SSLRequest = __nccwpck_require__(4269);
const TextRow = __nccwpck_require__(8175);
...
const ErrorCodeToName = __nccwpck_require__(5817);
const NativeBuffer = __nccwpck_require__(4293).Buffer;
const Long = __nccwpck_require__(1254);
const StringParser = __nccwpck_require__(6698);
...
const Packet = __nccwpck_require__(555);
const ClientConstants = __nccwpck_require__(3145);
const ServerSatusFlags = __nccwpck_require__(818);

const EncodingToCharset = __nccwpck_require__(1435);
const sessionInfoTypes = __nccwpck_require__(6207);
...
const FieldFlags = __nccwpck_require__(8090);
const Charsets = __nccwpck_require__(2527);
const Types = __nccwpck_require__(4297);
const helpers = __nccwpck_require__(5245);
const genFunc = __nccwpck_require__(490);
const parserCache = __nccwpck_require__(9927);
const typeNames = [];
...
const Iconv = __nccwpck_require__(1242);
...
const process = __nccwpck_require__(1765);
const mysql = __nccwpck_require__(3399);

const EventEmitter = __nccwpck_require__(8614).EventEmitter;
const PoolConnection = __nccwpck_require__(2904);
const Queue = __nccwpck_require__(451);
const Connection = __nccwpck_require__(7945);
...
class Pool extends EventEmitter {
  ...
  promise(promiseImpl) {
    const PromisePool = __nccwpck_require__(8806).PromisePool;
...
const Connection = __nccwpck_require__(3399).Connection;
...
class PoolConnection extends Connection {
  ...
  promise(promiseImpl) {
    const PromisePoolConnection = __nccwpck_require__(8806).PromisePoolConnection;
...
const core = __nccwpck_require__(3399);
const EventEmitter = __nccwpck_require__(8614).EventEmitter;
...
function createCompiler(config) {
  ...
  if (config.cache !== false && !cache) {
    cache = __nccwpck_require__(7925)({ max: ncache, dispose: EMPTY_LRU_FN });
  }
...
var Map = __nccwpck_require__(3901)
var util = __nccwpck_require__(1669)

// A linked list to keep track of recently-used-ness
var Yallist = __nccwpck_require__(5605)
...
if (typeof Map === 'function' && !process.env.TEST_PSEUDOMAP) {
  ...
  module.exports = __nccwpck_require__(4178)
}
...
module.exports = __nccwpck_require__(9729);
...
try {
  ...
  __nccwpck_require__(8372)(Yallist)
} catch (er) {}
