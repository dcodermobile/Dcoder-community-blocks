...
const main = async(inputs, auths, event) => {
  ...
  const request = {
    name: client.projectPath(projectId)+ '/metricDescriptors/compute.googleapis.com/instance/disk/write_ops_count',
    filter: `metric.type="compute.googleapis.com/instance/disk/write_ops_count" AND metric.labels.instance_name="${inputs.instanceName}"`,
    interval: {
      startTime: {
