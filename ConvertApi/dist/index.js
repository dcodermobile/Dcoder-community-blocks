...
const main = 
  ...
  var convertapi = __nccwpck_require__(4298)(secret_key);
  let result = null;
  if(from){
...
module.exports = __nccwpck_require__(9640);
...
var utils = __nccwpck_require__(5339);
var settle = __nccwpck_require__(9570);
var buildFullPath = __nccwpck_require__(4470);
var buildURL = __nccwpck_require__(7101);
var http = __nccwpck_require__(8605);
var https = __nccwpck_require__(7211);
var httpFollow = __nccwpck_require__(3510).http;
var httpsFollow = __nccwpck_require__(3510).https;
var url = __nccwpck_require__(8835);
var zlib = __nccwpck_require__(8761);
var pkg = __nccwpck_require__(696);
var createError = __nccwpck_require__(4661);
var enhanceError = __nccwpck_require__(9648);
...
var utils = __nccwpck_require__(5339);
var settle = __nccwpck_require__(9570);
var cookies = __nccwpck_require__(8031);
var buildURL = __nccwpck_require__(7101);
var buildFullPath = __nccwpck_require__(4470);
var parseHeaders = __nccwpck_require__(2934);
var isURLSameOrigin = __nccwpck_require__(4793);
var createError = __nccwpck_require__(4661);
...
var utils = __nccwpck_require__(5339);
var bind = __nccwpck_require__(6297);
var Axios = __nccwpck_require__(3240);
var mergeConfig = __nccwpck_require__(7719);
var defaults = __nccwpck_require__(3708);
...
axios.Cancel = __nccwpck_require__(8833);
axios.CancelToken = __nccwpck_require__(7759);
axios.isCancel = __nccwpck_require__(1212);

// Expose all/spread
axios.all = function all(promises) {
  return Promise.all(promises);
};
axios.spread = __nccwpck_require__(7289);

// Expose isAxiosError
axios.isAxiosError = __nccwpck_require__(1308);
...
var Cancel = __nccwpck_require__(8833);
...
var utils = __nccwpck_require__(5339);
var buildURL = __nccwpck_require__(7101);
var InterceptorManager = __nccwpck_require__(2870);
var dispatchRequest = __nccwpck_require__(1827);
var mergeConfig = __nccwpck_require__(7719);
...
var isAbsoluteURL = __nccwpck_require__(6453);
var combineURLs = __nccwpck_require__(5926);
...
var utils = __nccwpck_require__(5339);
var transformData = __nccwpck_require__(769);
var isCancel = __nccwpck_require__(1212);
var defaults = __nccwpck_require__(3708);
...
var utils = __nccwpck_require__(5339);
var normalizeHeaderName = __nccwpck_require__(2023);
...
function getDefaultAdapter() {
  ...
  if (typeof XMLHttpRequest !== 'undefined') {
    ...
    adapter = __nccwpck_require__(8444);
  } else if (typeof process !== 'undefined' && Object.prototype.toString.call(process) === '[object process]') {
    // For node use HTTP adapter
    adapter = __nccwpck_require__(2330);
  }
  return adapter;
}
...
var _axios = __nccwpck_require__(9321);
...
var _utils = __nccwpck_require__(3858);

var _upload_result = __nccwpck_require__(7412);

var _upload_result2 = _interopRequireDefault(_upload_result);

var _error = __nccwpck_require__(6249);
...
class Client {
  ...
  download(url, path) {
    ...
    return _asyncToGenerator(function* () {
      ...
      response.data.pipe(_fs2.default.createWriteStream(path));
...
var _package = __nccwpck_require__(7709);

var _package2 = _interopRequireDefault(_package);

var _task = __nccwpck_require__(5951);

var _task2 = _interopRequireDefault(_task);

var _client = __nccwpck_require__(8643);
...
var _result_file = __nccwpck_require__(5975);
...
var _result = __nccwpck_require__(9217);
...
var _querystring = __nccwpck_require__(1191);
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __nccwpck_require__(6349)("follow-redirects");
    }
    catch (error) {
      debug = function () { /* */ };
    }
...
var debug = __nccwpck_require__(6728);
...
"use strict";
module.exports = JSON.parse('{"_args":[["axios@0.21.1","/home/dcoder/ConvertApi"]],"_from":"axios@0.21.1","_id":"axios@0.21.1","_inBundle":false,"_integrity":"sha512-dKQiRHxGD9PPRIUNIWvZhPTPpl1rf/OxTYKsqKUDjBwYylTvV7SjSHJb9ratfyzM6wCdLCOYLzs73qpg5c4iGA==","_location":"/axios","_phantomChildren":{},"_requested":{"type":"version","registry":true,"raw":"axios@0.21.1","name":"axios","escapedName":"axios","rawSpec":"0.21.1","saveSpec":null,"fetchSpec":"0.21.1"},"_requiredBy":["/convertapi"],"_resolved":"https://registry.npmjs.org/axios/-/axios-0.21.1.tgz","_spec":"0.21.1","_where":"/home/dcoder/ConvertApi","author":{"name":"Matt Zabriskie"},"browser":{"./lib/adapters/http.js":"./lib/adapters/xhr.js"},"bugs":{"url":"https://github.com/axios/axios/issues"},"bundlesize":[{"path":"./dist/axios.min.js","threshold":"5kB"}],"dependencies":{"follow-redirects":"^1.10.0"},"description":"Promise based HTTP client for the browser and node.js","devDependencies":{"bundlesize":"^0.17.0","coveralls":"^3.0.0","es6-promise":"^4.2.4","grunt":"^1.0.2","grunt-banner":"^0.6.0","grunt-cli":"^1.2.0","grunt-contrib-clean":"^1.1.0","grunt-contrib-watch":"^1.0.0","grunt-eslint":"^20.1.0","grunt-karma":"^2.0.0","grunt-mocha-test":"^0.13.3","grunt-ts":"^6.0.0-beta.19","grunt-webpack":"^1.0.18","istanbul-instrumenter-loader":"^1.0.0","jasmine-core":"^2.4.1","karma":"^1.3.0","karma-chrome-launcher":"^2.2.0","karma-coverage":"^1.1.1","karma-firefox-launcher":"^1.1.0","karma-jasmine":"^1.1.1","karma-jasmine-ajax":"^0.1.13","karma-opera-launcher":"^1.0.0","karma-safari-launcher":"^1.0.0","karma-sauce-launcher":"^1.2.0","karma-sinon":"^1.0.5","karma-sourcemap-loader":"^0.3.7","karma-webpack":"^1.7.0","load-grunt-tasks":"^3.5.2","minimist":"^1.2.0","mocha":"^5.2.0","sinon":"^4.5.0","typescript":"^2.8.1","url-search-params":"^0.10.0","webpack":"^1.13.1","webpack-dev-server":"^1.14.1"},"homepage":"https://github.com/axios/axios","jsdelivr":"dist/axios.min.js","keywords":["xhr","http","ajax","promise","node"],"license":"MIT","main":"index.js","name":"axios","repository":{"type":"git","url":"git+https://github.com/axios/axios.git"},"scripts":{"build":"NODE_ENV=production grunt build","coveralls":"cat coverage/lcov.info | ./node_modules/coveralls/bin/coveralls.js","examples":"node ./examples/server.js","fix":"eslint --fix lib/**/*.js","postversion":"git push && git push --tags","preversion":"npm test","start":"node ./sandbox/server.js","test":"grunt test && bundlesize","version":"npm run build && grunt version && git add -A dist && git add CHANGELOG.md bower.json package.json"},"typings":"./index.d.ts","unpkg":"dist/axios.min.js","version":"0.21.1"}');
...
"use strict";
module.exports = JSON.parse('{"_args":[["convertapi@1.11.1","/home/dcoder/ConvertApi"]],"_from":"convertapi@1.11.1","_id":"convertapi@1.11.1","_inBundle":false,"_integrity":"sha512-k5HBX4/k2wBQAODMpISABVxVRJR0xALrXEMhx0JgOajadU3DMD1wNnSyizpHnOyo9RncJnazF7EpJThTHFOtTQ==","_location":"/convertapi","_phantomChildren":{},"_requested":{"type":"version","registry":true,"raw":"convertapi@1.11.1","name":"convertapi","escapedName":"convertapi","rawSpec":"1.11.1","saveSpec":null,"fetchSpec":"1.11.1"},"_requiredBy":["/"],"_resolved":"https://registry.npmjs.org/convertapi/-/convertapi-1.11.1.tgz","_spec":"1.11.1","_where":"/home/dcoder/ConvertApi","author":{"name":"Tomas Rutkauskas","email":"support@convertapi.com"},"bugs":{"url":"https://github.com/ConvertAPI/convertapi-node/issues"},"dependencies":{"axios":"^0.21.1"},"description":"Official convertapi.com API client","devDependencies":{"babel-cli":"^6.26.0","babel-eslint":"^8.2.1","babel-plugin-add-module-exports":"^0.2.1","babel-polyfill":"^6.26.0","babel-preset-env":"^1.6.1","babel-preset-minify":"^0.4.3","chai":"^4.1.2","chai-as-promised":"^ 7.1.1","chai-fs":"^2.0.0","cross-env":"^5.1.3","eslint":"^4.19.1","eslint-config-airbnb":"^17.0.0","eslint-plugin-import":"^2.7.0","eslint-plugin-jsx-a11y":"^6.0.2","eslint-plugin-react":"^7.4.0","istanbul":"^1.0.0-alpha","mocha":"^5.0.0","rimraf":"^2.6.2"},"files":["lib","src","index.d.ts"],"homepage":"https://github.com/ConvertAPI/convertapi-node#readme","keywords":["convert","api","client","sdk","conversion","convertapi","files"],"license":"MIT","main":"./lib/index.js","name":"convertapi","repository":{"type":"git","url":"git+https://github.com/ConvertAPI/convertapi-node.git"},"scripts":{"build":"cross-env BABEL_ENV=production babel src --out-dir lib","clean":"rimraf lib","cover":"istanbul cover _mocha -- --require babel-core/register --require babel-polyfill --recursive --timeout 15000","lint":"eslint src test","prepublish":"npm run clean && npm run lint && npm run test && npm run build","test":"npm run lint && npm run cover","test:examples":"node examples/","test:only":"mocha --require babel-core/register --require babel-polyfill --recursive --timeout 15000","test:prod":"cross-env BABEL_ENV=production npm run test","test:watch":"npm test -- --watch"},"types":"./index.d.ts","version":"1.11.1"}');
