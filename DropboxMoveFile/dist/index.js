...
const main = async (inputs, auths, event) => {
  const fetch = __nccwpck_require__(374);
  const { Dropbox } = __nccwpck_require__(103);
...
var _dropbox = __nccwpck_require__(364);
...
var _auth = __nccwpck_require__(678);
...
var _response = __nccwpck_require__(690);
...
var _error = __nccwpck_require__(622);
...
var _utils = __nccwpck_require__(971);
...
if ((0, _utils.isBrowserEnv)()) {
  ...
  fetch = __nccwpck_require__(514); // eslint-disable-line global-require
}
...
if ((0, _utils.isBrowserEnv)()) {
  ...
  crypto = __nccwpck_require__(113); // eslint-disable-line global-require
}

var Encoder;

if (typeof TextEncoder === 'undefined') {
  Encoder = (__nccwpck_require__(837).TextEncoder); // eslint-disable-line global-require
} else {
  Encoder = TextEncoder;
...
var _constants = __nccwpck_require__(910);

var _routes = __nccwpck_require__(658);
...
var realFetch = __nccwpck_require__(514);
...
var whatwgUrl = _interopDefault(__nccwpck_require__(935));
...
let convert;
try {
	convert = (__nccwpck_require__(244).convert);
} catch (e) {}
...
const usm = __nccwpck_require__(682);
...
const conversions = __nccwpck_require__(172);
const utils = __nccwpck_require__(758);
const Impl = __nccwpck_require__(256);
...
exports.URL = __nccwpck_require__(847)["interface"];
exports.serializeURL = __nccwpck_require__(682).serializeURL;
exports.serializeURLOrigin = __nccwpck_require__(682).serializeURLOrigin;
exports.basicURLParse = __nccwpck_require__(682).basicURLParse;
exports.setTheUsername = __nccwpck_require__(682).setTheUsername;
exports.setThePassword = __nccwpck_require__(682).setThePassword;
exports.serializeHost = __nccwpck_require__(682).serializeHost;
exports.serializeInteger = __nccwpck_require__(682).serializeInteger;
exports.parseURL = __nccwpck_require__(682).parseURL;
...
const tr46 = __nccwpck_require__(867);
